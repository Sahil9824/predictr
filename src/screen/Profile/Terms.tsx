      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, padding: 16 }}>
          ...
          <Text style={styles.text}>
            Welcome to StockAlgos Inc.! By accessing, browsing, or using any
            part of the services provided by stockalgos.com ("the Site"), you
          ...
          <Text style={styles.text}>
            ...
            jurisdiction, to form a binding contract to use the Site. By
            accessing the Site, you also agree that the laws of the Province of
            Ontario, Canada, without regard to conflict of law principles, shall
            govern these Terms and any dispute that may arise.
          </Text>
          ...
          <Text style={styles.text}>
            ...
            services provided by stockalgos.com are strictly for informational
            and educational purposes and are not intended as, and should not be
            construed as, professional financial advice.
          </Text>
          <Text style={styles.text}>
            Users should not rely on the data or information provided on the
            Site for making investment decisions without seeking advice from
            qualified financial professionals. StockAlgos Inc. disclaims any
            responsibility for investment decisions made based on the content
